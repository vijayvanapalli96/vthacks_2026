# VT Hacks Career Application

The shared frontend baseline uses React 19 and Next.js 16 and is deployable as a Databricks App.
...
Open `http://localhost:3000`. The active Next.js source lives in `src/app/`.
