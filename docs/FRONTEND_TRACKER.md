...
**Locked palette:** `#eef4ed` paper (surface) · `#0b2545` ink (text) · `#3b6064` success · `#8c2f39` failure · **Forum** display / neutral sans for body. Light surface only — the signal colours fail contrast on navy.
...
|---|----|------|-----------------|------------------------|------|--------|
| [ ] | F1 | Design tokens | `Set up our design tokens in globals.css — paper #eef4ed surface, ink #0b2545 text, success #3b6064, failure #8c2f39. Load Forum from Google Fonts for display only (it has no bold — hierarchy via size/letter-spacing/opacity) plus a neutral sans for body/UI. 8px spacing, one radius, 2px ink focus ring, type scale 14/16/20/32/56.` | Whole site turns paper-and-ink with Forum headings. Nothing new appears, but everything after this is automatically on-brand. | 30m | 🔴 |
...
**Phase S: 1h 50m · running total 3h 25m**
...
**Phase H: 2h 10m · running total 5h 35m**
...
**Phase P: 1h 50m · running total 7h 25m**
...
**Phase X: 50m · TOTAL P0-only 6h 25m · everything 8h 15m**
