...
// Valderrama. Original path: career-ops/providers/_html-entities.mjs. Licence
// text in ../LICENSE.career-ops. Only this header was added; do not edit the
// logic — re-copy from the donor repo instead.
// @ts-check
