...
// Valderrama. Original path: career-ops/providers/_types.js. Licence text in
// ../LICENSE.career-ops. Only this header was added.
// Read the `Job` and `Provider` typedefs below before touching the scanner: they
// are the contract scan-us-jobs.mjs is written against, including the optional
// `dedupKey()` that job_id prefers over a URL.
