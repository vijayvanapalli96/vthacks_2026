...
// Valderrama. Original path: career-ops/providers/ashby.mjs. Licence text in
// ../LICENSE.career-ops. Only this header was added; do not edit the logic —
// re-copy from the donor repo instead. The 30s timeout + backoff below is load-
// bearing: Ashby has a ~10s server-side latency floor and rate-limits repeated
// anonymous hits, so the scanner paces Ashby boards (see scan-us-jobs.mjs).
// @ts-check
