// LIFTED VERBATIM from career-ops v1.33.0 — MIT, (c) 2026 Santiago Fernandez de
// Valderrama. Original path: career-ops/providers/icims.mjs. Licence text in
// ../LICENSE.career-ops. Only this header was added; do not edit the logic —
// re-copy from the donor repo instead.
// NOT USED by boards.json today: this provider parses the hosted portal's HTML
// search pages rather than a JSON API, and the seed list is Greenhouse / Ashby /
// Lever only. Kept so an iCIMS board can be added without another lift.
// @ts-check
