...
// Valderrama. Original path: career-ops/providers/workday.mjs. Licence text in
// ../LICENSE.career-ops. Only this header was added; do not edit the logic —
// re-copy from the donor repo instead. `workdayDedupKey` is the requisition-id
// key HIREWIRE prefers over urlKey() (see scan-us-jobs.mjs `jobIdFor`).
// @ts-check
