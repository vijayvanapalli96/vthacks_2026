...
// Valderrama. Original path: career-ops/user-agent.mjs. Licence text in
// ./LICENSE.career-ops. Only this header was added; do not edit — re-copy from
// the donor repo instead. Lives one directory above providers/ because
// providers/_http.mjs imports it as '../user-agent.mjs' and the import graph is
