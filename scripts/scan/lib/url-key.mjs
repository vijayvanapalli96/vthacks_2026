...
// Valderrama. Original path: career-ops/url-key.mjs. Full licence text in
// scripts/scan/lib/LICENSE.career-ops.
// Only this header was added. Do NOT edit the logic here — re-copy from the
// donor repo instead. Read the "UNDER-STRIP ON PURPOSE" note below before you
// are tempted to normalise more aggressively.
// ---------------------------------------------------------------------------
/**
